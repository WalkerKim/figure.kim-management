...
//                .pathMatchers(HttpMethod.PUT, contextPath + "/account/{id}/tempPassword").hasAnyAuthority("SUPER")
//                .pathMatchers(HttpMethod.GET, contextPath + "/account/{id}/tempPassword").hasAnyAuthority("SUPER")
                .pathMatchers(HttpMethod.GET, contextPath + "/**").authenticated()
                .pathMatchers(HttpMethod.GET, contextPath+"/session-check").authenticated()
                .pathMatchers(HttpMethod.POST, contextPath + "/**").hasAnyAuthority("SUPER")
                .pathMatchers(HttpMethod.DELETE, contextPath + "/**").hasAnyAuthority("SUPER")
                .pathMatchers(HttpMethod.PUT, contextPath + "/**").hasAnyAuthority("SUPER")
//                .pathMatchers(HttpMethod.GET, contextPath+"/**").authenticated()
                .anyExchange().permitAll()
                .and()
                .cors()
